...
if (class_exists ( 'BloquebannerUsuario' ) === false) {
	class BloquebannerUsuario implements Bloque {
		var $nombreBloque;
		var $miFuncion;
		var $miSql;
		var $miConfigurador;
		...
		function __construct($esteBloque, $lenguaje = "") {
			...
			$nombreClaseFuncion = "Funcionbanner";
			$this->miFuncion = new $nombreClaseFuncion ();
			
			$nombreClaseSQL = "Sqlbanner";
			$this->miSql = new $nombreClaseSQL ();
			
			$nombreClaseFrontera = "Fronterabanner";
			$this->miFrontera = new $nombreClaseFrontera ();
			
			$nombreClaseLenguaje = "Lenguajebanner";
