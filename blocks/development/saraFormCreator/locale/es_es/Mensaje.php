...
$this->idioma ['errorCopia'] = '<p>Se ha generado un error al copiar los archivos.</p>';
$this->idioma ['errorDirectorio'] = '<p>Se ha generado un error al tratar de configurar el plugin.</p>';
...
$this->idioma ['errorNombre'] = '<p>Al parecer ya se encuentra configurado el plugin Reportico.</p>';
