...
namespace bloquesModelo\contenido\formulario;
...
class Formulario {
	...
	function formulario() {
		...
		// $atributos ['cadena_sql'] = $this->miSql->getCadenaSql("crearUsuario");
		// $esteRecurso->ejecutarAcceso($atributos['cadena_sql'], "crear");
		// echo $atributos ['cadena_sql'];
		$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarUsuario" );
