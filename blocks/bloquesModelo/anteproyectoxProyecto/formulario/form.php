...
class Formulario {
	...
	function formulario() {
		...
		$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarAnteproyecto" );
		$matrizItems = $esteRecurso->ejecutarAcceso ( $atributos ['cadena_sql'], "busqueda" );
		
		?>

<h2>Anteproyectos por programa curricular</h2>
<br>
...
<!-- 					<td class="">Fecha Radicacion</td> -->
<!-- 					<td class="w10pto">No. Anteproyecto</td> -->
<!-- 					<td class="">Modalidad de Grado</td> -->
<!-- 					<td class="">Titulo</td> -->
<!-- 					<td class="">Estado</td> -->
<!-- 				</tr> -->
        <?php
...
// 					if (isset ( $matrizItems [$i] [$j] )) {
// 						echo "<td class='w20pto align-center'>" . $matrizItems [$i] [$j] . "</td>";
// 					}
// 				}
// 				echo "</tr>";
// 			}
