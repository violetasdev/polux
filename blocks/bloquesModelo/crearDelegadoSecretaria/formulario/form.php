...
namespace bloquesModelo\asignarTematica\formulario;
...
class Formulario {
	...
	function formulario() {
		...
		$atributos ['mensaje'] = 'Delegado Secretaría Académica';
		...
		$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarSecretarias" );
